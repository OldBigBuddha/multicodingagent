...
async function main(): Promise<void> {
  ...
  const researchPrompt = "Research the OCI Runtime Specification and identify all required fields in the config.json file. Provide the field names, their data types, and any validation requirements.";
